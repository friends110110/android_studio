 ...
 * {
 ...
 "id_tracking":"GwSMCmFuZHJvaWRfaWQYD2Y1OTliZjA4NzViYTA3Mxbe5piaolcVAgAFdXRkaWQYGFdWeVVQem40 WFZBREFKd2NsakM3bHhURBbc5piaolcVAgAEaW1laRgPMDAwMDAwMDAwMDAwMDAwFuzlmJqiVxUC AAVpZG1kNRgeNTI4NDQ3ZjRmZmI0ZTQ4MjRhMmZkMWQxZjBjZDYyFujlmJqiVxUCABkMAA== ",
 "os":"Android",
 "app_signature":"BE:B9:05:B4:5D:71:55:8F:7F:70:3E:D1:A9:56:AD:94",
 "cpu":"0",
 "package_name":"com.umeng.example",
 "sdk_version":"6.1.1",
 "device_id":"000000000000000",
 "device_brand":"generic_x86",
 "access":"2G/3G",
 "country":"US",
 "os_version":"4.4.2",
 "idmd5":"528447f4ffb4e4824a2fd1d1f0cd62",
 "display_name":"UMENG SDK",
 "sdk_type":"Android",
 "device_manuid":"KK",
 "mccmnc":"310260",
 "language":"en",
 "channel":"Umeng",
 "device_manutime":1478741905000
 }
 }
 */
...
public class HttpContentTest {
    ...
    /**
     * aq JSONObject a(final int... array) 组装数据
     */
    @Test
   public void testGenerateSessionId() throws  Exception{
        //var10.put("app_signature", bv.u(j));
        String appSignature = u(mTasksActivityTestRule.getActivity());
         ...
         *   bm var1 = this.d.b();
             ...
             JSONObject var4 = this.j.getJSONObject("header");
             var4.put("id_tracking", var3);
            等同于
         * Base64.encodeToString(new cp().a(ad.a(g).b()),0)
         */
        String id_tracking = Base64.encodeToString(new cp().a(ad.a(mActivity).b()),0);
        /**
         * imprint 重点
         *
         ...
         */
            ...
            bn var18 = af.a(mActivity).a();//获取出bn对象
            if(var18 != null) {
